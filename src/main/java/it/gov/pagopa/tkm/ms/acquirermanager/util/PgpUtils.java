...
public class PgpUtils {
    ...
    public static byte[] decrypt(byte[] encryptedMessageBytes, byte[] privateKeyBytes, char[] passphraseChars) throws Exception {
    ...
    public static byte[] encrypt( byte[] message, PGPPublicKey publicKey, boolean armored )
            throws PGPException
    {
        try
        {
